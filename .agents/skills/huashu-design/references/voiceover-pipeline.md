...
const HERO_KEYS = {
  opening: {
    md: { x: 50, y: 35, scale: 1.0, opacity: 1 },
    html: { x: 50, y: 65, scale: 1.0, opacity: 1 },
  },
  'md-side': {
    md: { x: 78, y: 50, scale: 1.6, opacity: 1 },
    html: { x: 92, y: 8, scale: 0.25, opacity: 0.4 },
  },
  'html-side': {
    md: { x: 8, y: 8, scale: 0.25, opacity: 0.4 },
    html: { x: 22, y: 50, scale: 1.6, opacity: 1 },
  },
...
const App = () => (
  <NarrationStage
    timeline={TIMELINE}
    audioSrc="_narration/voiceover.mp3"
    width={1920}
    height={1080}
  >
...
>
  ...
  <Scene id="intro">
    <Cue id="bigmodel">
      {(triggered, progress) => <SomeElement style={{ opacity: progress }} />}
    </Cue>
  </Scene>
</NarrationStage>
```
