  ...
  return await page.evaluate(() => {
    ...
    document.querySelectorAll('*').forEach((el) => {
      ...
      if (el.tagName === 'DIV' && el.dataset && el.dataset.pptxMerge === 'true') {
        ...
        const mHasBg =
          mergeComputed.backgroundColor && mergeComputed.backgroundColor !== 'rgba(0, 0, 0, 0)'
        const mBorders = [
        ...
        const baseStyle = {
          ...
          lineSpacing:
            firstComputed.lineHeight && firstComputed.lineHeight !== 'normal'
        ...
        textDescendants.forEach((textEl, idx) => {
          ...
          let runs
          if (hasInline) {
            runs = parseInlineFormatting(textEl, runBaseOptions, [], (str) =>
