  ...
  return (
    <div className="fixed inset-0 z-[80] flex items-center justify-center p-4">
      ...
      <motion.div
        ...
        className="relative max-w-md w-full bg-gradient-to-br from-white/10 to-white/5 backdrop-blur-xl border border-white/20 rounded-3xl p-8 shadow-2xl"
        role="dialog"
        aria-modal="true"
      ...
      >
        <button
          onClick={onClose}
          className="absolute top-4 right-4 min-w-[44px] min-h-[44px] flex items-center justify-center bg-black/40 hover:bg-black/60 border border-white/20 hover:border-white/40 rounded-full transition-all duration-200 backdrop-blur-sm"
          aria-label="Cerrar"
        >
          ✕
        </button>
        ...
        <div className="text-center">
          ...
          <h3 className="text-xl font-bold text-white mb-2">Acceso requerido</h3>
