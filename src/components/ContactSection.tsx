            ...
            {status === 'success' ? (
              ...
              <form onSubmit={handleSubmit} className="flex flex-col gap-4 h-full">
                ...
                <motion.button
                  ...
                  className="group flex w-full items-center justify-center gap-3 rounded-xl border border-black/40 bg-white/6 px-6 py-4 font-semibold text-white transition-all hover:border-black hover:bg-accent-cyan/10 disabled:cursor-not-allowed disabled:opacity-50"
