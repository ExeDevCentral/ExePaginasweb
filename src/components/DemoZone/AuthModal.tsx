  ...
  return (
    <div className="p-8 bg-primary-bg/80 backdrop-blur-xl border border-accent-cyan/30 rounded-[2.5rem] shadow-2xl max-w-md w-full mx-auto">
      ...
      <div className="space-y-4">
        ...
        >
          <img
            src="https://www.gstatic.com/firebase/explore/google-logo.svg"
            className="w-5 h-5"
            alt="Google"
          />
      ...
      <div className="mt-8 pt-6 border-t border-white/5 text-center">
        <p className="text-xs text-primary-secondary leading-relaxed">
          ...
          <a href="/terms" className="text-accent-magenta hover:underline">
            Términos de Servicio
          </a>{' '}
          y
          <a href="/privacy" className="text-accent-magenta hover:underline ml-1">
            Privacidad
          </a>
          .
        </p>
