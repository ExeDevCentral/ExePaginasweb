...
const PROPERTIES = [
  { id: 1, type: 'casa', name: 'Villa Serena', location: 'Zona Norte · Buenos Aires', price: 'USD 285,000', beds: 4, baths: 3, m2: 220, gradient: 'from-stone-700 to-stone-900', image: '/assets/casa-aura/1.webp', tag: 'Destacada' },
  { id: 2, type: 'depto', name: 'Loft Aura Centro', location: 'Microcentro · CABA', price: 'USD 95,000', beds: 1, baths: 1, m2: 58, gradient: 'from-slate-700 to-slate-900', image: '/assets/casa-aura/2.webp', tag: 'Nuevo' },
  { id: 3, type: 'casa', name: 'Casa del Lago', location: 'Tigre · GBA', price: 'USD 420,000', beds: 5, baths: 4, m2: 380, gradient: 'from-emerald-900 to-stone-900', image: '/assets/casa-aura/3.webp', tag: 'Premium' },
  { id: 4, type: 'depto', name: 'Studio Palermo', location: 'Palermo · CABA', price: 'USD 72,000', beds: 1, baths: 1, m2: 42, gradient: 'from-zinc-700 to-zinc-900', image: '/assets/casa-aura/4.webp', tag: 'Oportunidad' },
          ...
          >
            ...
            {selectedProject.title === 'Casa Aura' ? (
                ...
                >
                  ...
                  {/* Top bar */}
                  <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between px-4 sm:px-7 py-4 sm:py-5 border-b border-white/6 shrink-0 gap-4 sm:gap-0">
                    <div className="flex items-center gap-3 sm:gap-4 w-full sm:w-auto justify-between sm:justify-start">
                      <div className="flex items-center gap-2">
                        <h2 className="font-montserrat font-black text-xl sm:text-2xl text-white tracking-tight">
                  ...
                  <div className="flex flex-col lg:flex-row flex-1 overflow-hidden">
                    ...
                    <div className="lg:w-[52%] h-1/2 lg:h-full w-full shrink-0 relative overflow-hidden border-b lg:border-b-0 lg:border-r border-white/6">
