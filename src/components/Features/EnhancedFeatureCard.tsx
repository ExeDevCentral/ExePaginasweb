...
export default function EnhancedFeatureCard({ icon: Icon, title, description, colorClass }: EnhancedFeatureCardProps) {
  ...
  return (
    ...
    >
      <motion.div
        className="relative h-full overflow-hidden rounded-3xl border border-white/10 bg-slate-900/40 p-0"
      ...
      >
        ...
        <div className="relative p-6">
          <div className="flex items-center justify-between gap-4">
            ...
            >
              <Icon className="h-full w-full text-slate-950" />
            </motion.div>
          ...
          <h3 className="mt-5 mb-3 font-montserrat text-2xl font-black text-white">
            {title}
          </h3>
          ...
          {/* Sin fotos: mantenemos un placeholder visual con glow sutil */}
          <div className="mt-6 h-10 rounded-2xl border border-white/5 bg-white/2/50 relative overflow-hidden">
