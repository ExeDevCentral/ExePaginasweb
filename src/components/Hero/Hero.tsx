...
const Hero = () => {
  ...
  const typewriterText = "Sistemas web para negocios locales"
  ...
  return (
    ...
    >
      ...
      >
        ...
        >
          Soluciones digitales · Sistemas a medida · Automatización
        </motion.p>
        <motion.h1
          className="mb-6 font-montserrat text-5xl font-black leading-[0.95] tracking-tight sm:text-6xl lg:text-7xl"
          variants={itemVariants}
          transition={{ duration: 0.8, ease: "easeOut" }}
        >
          <span className="text-gradient-animated">Sistemas Web</span>
          <br />
          <span className="text-primary-text">para Negocios Locales</span>
        </motion.h1>
        ...
        <motion.p
          ...
          transition={{ duration: 0.8, ease: "easeOut" }}
        >
          Transformá tu negocio con sistemas web a medida: reservas online, gestión de stock, 
          CRM y más. Soluciones reales que te ayudan a vender más y trabajar mejor.
        </motion.p>
        ...
        >
          <motion.a
            className="transform rounded-full bg-gradient-to-r from-accent-cyan to-accent-magenta px-8 py-4 text-lg font-semibold text-primary-bg shadow-lg shadow-accent-cyan/30 transition-all duration-300 hover:scale-105 hover:shadow-xl hover:shadow-accent-cyan/40 flex items-center gap-2"
            href="#products"
          ...
          <motion.a
            className="flex items-center gap-2 rounded-full border-2 border-black/60 px-8 py-4 text-lg font-semibold text-accent-cyan transition-all duration-300 hover:border-black hover:bg-accent-cyan/10 hover:text-primary-text"
            href="#contact"
            whileHover={{ scale: 1.05 }}
            whileTap={{ scale: 0.95 }}
          >
        ...
        {/* Quick Stats */}
        <motion.div
          className="mt-12 flex flex-wrap justify-center gap-8 text-sm text-primary-secondary"
          variants={itemVariants}
          transition={{ duration: 0.8, ease: "easeOut" }}
        >
