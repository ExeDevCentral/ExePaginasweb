  ...
  return (
    ...
    >
      ...
      >
        ...
        />
        <div
          className={`absolute top-0 left-0 right-0 h-[1px] bg-gradient-to-r from-transparent ${product.color} to-transparent opacity-0 group-hover:opacity-40 transition-opacity duration-500`}
        />
        ...
        <div className="flex items-center justify-between pt-5 border-t border-border">
          ...
          <motion.button
            ...
            className="flex items-center gap-2 px-6 py-3 rounded-xl bg-gradient-to-r from-accent-cyan to-accent-magenta text-primary-bg text-sm font-bold shadow-md shadow-accent-cyan/15 hover:shadow-accent-cyan/35 transition-all"
