      ...
      return (
        <div className="rounded-3xl border border-rose-500/40 bg-[#090a12]/90 backdrop-blur-2xl p-8 shadow-[0_0_40px_rgba(244,63,94,0.15)] text-center my-6">
          ...
          <button
            ...
            className="mt-6 inline-flex items-center gap-2 px-6 py-3 rounded-2xl font-bold text-xs bg-rose-500/20 hover:bg-rose-500/30 text-rose-300 border border-rose-500/40 transition-all shadow-md"
          >
