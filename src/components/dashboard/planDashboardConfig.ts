...
export const PLAN_THEMES: Record<Exclude<PlanTier, 'none'>, PlanDashboardTheme> = {
  basico: {
    ...
    perks: ['Hosting Vercel Edge', 'SSL automático', 'Soporte estándar', 'Actualizaciones de seguridad'],
  ...
  avanzado: {
    ...
    accentMuted: 'text-purple-300/80',
    ...
    activities: [
      ...
      { label: 'Pago Mercado Pago aprobado', time: 'hace 22m', status: 'ok' },
  ...
  premium: {
    ...
    perks: ['Account Manager', '2h dev/mes', 'Edge prioritario', 'Consultoría estratégica', 'Roadmap dedicado'],
