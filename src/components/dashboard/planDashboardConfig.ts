...
export const PLAN_THEMES: Record<Exclude<PlanTier, 'none'>, PlanDashboardTheme> = {
  ...
  avanzado: {
    ...
    subtitle: 'Gestión de reservas, base de datos de clientes y automatizaciones en tiempo real.',
    ...
    metrics: [
      ...
      { label: 'Notificaciones activas', value: '100%', delta: '100% OK ↗', trend: 'up' },
    ],
    ...
    activities: [
      ...
      { label: 'Recordatorio automático enviado al cliente', time: 'hace 1h', status: 'info' },
    ...
    supportDetail: 'Mesa de ayuda y tickets en el panel · Respuesta < 2h',
  },
  premium: {
    tier: 'premium',
