...
export default function AuthCallback() {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-[#050508]">
      <div className="text-center p-6 max-w-lg w-full bg-white/5 border border-white/10 rounded-3xl backdrop-blur-xl">
        <div className="w-12 h-12 border-2 border-accent-cyan border-t-transparent rounded-full animate-spin mx-auto mb-4" />
        <p className="text-white font-medium text-lg">Verificando sesión segura...</p>
        <p className="mt-2 text-xs text-primary-secondary font-mono bg-black/40 p-4 rounded-xl border border-white/5 text-left break-all">
          {debugMsg}
        </p>
      </div>
    </div>
